                ...
                <div className="w-full max-w-4xl mx-auto lg:mx-0">
                    ...
                    <div className="relative flex w-full max-w-[600px] items-center rounded-full bg-white px-2 shadow-2xl mx-auto lg:mx-0 transition-transform hover:scale-[1.01]">
                        <input
                            ...
                            className="flex-1 bg-transparent px-6 py-3 text-lg text-[#1A1A2E] placeholder:text-[#444] focus:outline-none"
                        />
                        <button
                            onClick={handleSearch}
                            className="ml-2 bg-[#1F3A5F] hover:bg-[#162942] p-3 rounded-full transition-colors group"
                        >
