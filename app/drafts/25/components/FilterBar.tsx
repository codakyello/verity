                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    ...
                    <div className="relative max-w-md flex-1">
                        ...
                        <input
                            ...
                            className="w-full border border-[#E7E5E4] bg-[#FAF9F7] pl-11 pr-4 py-3 text-sm text-[#1C1917] placeholder:text-[#A8A29E] focus:border-[#B45309] focus:bg-white focus:outline-none transition-all"
                        />
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        {propertyTypes.map((type) => (
                            <button
                                ...
                                className={`px-4 py-2 text-sm transition-all border ${filters.type === type
                                    ...
                                    : 'bg-white text-[#1C1917] border-[#E7E5E4] hover:border-[#B45309]'
                                    }`}
                            >
                                {type}
                            </button>
                        ...
                        <div className="w-px h-6 bg-[#E7E5E4] mx-1 hidden lg:block" />

                        <select
                            value={filters.location}
                            onChange={(e) => setLocationFilter(e.target.value)}
                            className="border border-[#E7E5E4] bg-white px-3 py-2 text-sm text-[#1C1917] focus:border-[#B45309] focus:outline-none cursor-pointer"
                        >
