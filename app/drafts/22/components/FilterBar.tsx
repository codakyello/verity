                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    ...
                    <div className="relative max-w-md flex-1">
                        ...
                        <input
                            ...
                            className="w-full border border-[#E5E7EB] bg-[#F9FAFB] pl-11 pr-4 py-3 text-sm text-[#1A1A1A] placeholder:text-[#9CA3AF] focus:border-[#2D4739] focus:bg-white focus:outline-none transition-all"
                        />
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        {propertyTypes.map((type) => (
                            <button
                                ...
                                className={`px-4 py-2 text-sm transition-all border ${filters.type === type
                                    ...
                                    : 'bg-white text-[#1A1A1A] border-[#E5E7EB] hover:border-[#2D4739]'
                                    }`}
                            >
                                {type}
                            </button>
                        ...
                        <select
                            ...
                            className="border border-[#E5E7EB] bg-white px-3 py-2 text-sm text-[#1A1A1A] focus:border-[#2D4739] focus:outline-none cursor-pointer"
                        >
