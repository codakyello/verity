...
export default function PropertyCard({ property }: { property: Property }) {
    return (
        <div className="group flex flex-col">
            {/* Image */}
            <div className="relative aspect-[4/3] w-full overflow-hidden border border-[#E8E6E3] bg-[#F5F4F2]">
                <img
                ...
                />
                {property.isVerified && (
                    <div className="absolute bottom-3 left-3 flex items-center gap-1.5 border border-[#E8E6E3] bg-white/95 px-2.5 py-1 text-xs font-medium text-[#722F37] backdrop-blur-sm">
