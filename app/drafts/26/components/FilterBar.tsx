                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    ...
                    <div className="relative max-w-md flex-1">
                        ...
                        <input
                            ...
                            className="w-full border border-[#E5E7EB] bg-[#F9FAFB] pl-11 pr-4 py-3 text-sm text-[#1A1A2E] placeholder:text-[#9CA3AF] focus:border-[#1E3A5F] focus:bg-white focus:outline-none transition-all"
                        />
                    </div>
